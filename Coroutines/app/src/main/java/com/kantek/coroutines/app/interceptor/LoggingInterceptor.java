...
public class LoggingInterceptor implements Interceptor {
    ...
    private static Runnable createPrintJsonResponseRunnable(final LoggingInterceptor.Builder builder, final long chainMs, final boolean isSuccessful, final int code, final String headers, final String bodyString, final List<String> segments, final String message, final String responseUrl) {
        return new Runnable() {
            public void run() {
    ...
    private static Runnable createFileResponseRunnable(final LoggingInterceptor.Builder builder, final long chainMs, final boolean isSuccessful, final int code, final String headers, final List<String> segments, final String message) {
        return new Runnable() {
            public void run() {
    ...
    public static class Builder {
        ...
        public LoggingInterceptor.Builder setLevel(Logger.Level level) {
            this.level = level;
            return this;
        }
        ...
        public LoggingInterceptor.Builder addQueryParam(String name, String value) {
        ...
        public LoggingInterceptor.Builder executor(Executor executor) {
            this.executor = executor;
            return this;
        }

        public LoggingInterceptor.Builder enableMock(boolean useMock, long sleep, BufferListener listener) {
        ...
        public LoggingInterceptor.Builder enableAndroidStudio_v3_LogsHack(boolean useHack) {
